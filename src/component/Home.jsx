        ...
        <div id="homeSection2" className="py-5   homeSection2 overflow-auto ">
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                Essiano has a diverse background including working in Rome in a
                high end restaurant. In only his second month he was a top
                producer at Capilano VW and continues to shine. He has been top
                salesman 6 times out of the last eight.
              </span>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                ...
                prior. From Lot Guy to a Sales Guy, good things can happen with
                solid training !!
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail">
                ...
                and never looked back. He is very successful selling cars at the
                prestigious Capilano Audi.
              </span>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              <span className="storyDealership block">Capilano VW</span>
              <span className="storyDetail ">
                Sarah comes from a management background in restaurants and pubs
                back in Scotland. She is enjoying her exciting role as one of
                the top producers at Capilano VW.
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                ...
                customer home when he was a lot attendant. 3 days later Levi was
                involved in the training and a week later became a sales
                professional with Regency Toyota. With Paul’s connections and
                mentorship he has transformed many lives for not just a job but
                a CAREER !
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                ...
                saw huge results in sales. Over 13 yrs later, he is now a Sales
                Manager at White Rock Hyundai.
              </span>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              <span className="storyDealership block">Capilano Audi</span>
              <span className="storyDetail">
                Aaron was a property manager and wanted to change his career as
                he felt he had reached his potential. Aaron was introduced to
                Derek Lau through Paul’s connections and was hired immediately.
                He is prospering at Capilano Audi as a top seller !!
              </span>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                ...
                to his long time friend Kirt Gill at Open Road Mazda. Frank was
                a top performer and has since moved on to Open Road Lexus of
                Port Moody. Frank has remained very close to Paul and often
          ...
          >
            ...
            <div>
              ...
              <span className="storyDetail ">
                ...
                sales manager for the Destination group in 2022! His success is
                all about Customer Service and listening to the customers needs
                and wants. He has also won a prestigious award in customer
                service for being ranked number two in all of Canada with a 96%
                customer satisfaction rate for Mazda.
              </span>
            </div>
          </div>
        </div>
