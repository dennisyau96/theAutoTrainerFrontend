  ...
  return (
    <>
      <div className="text-center justify-items-center" id="programDiv">
        ...
        <h2 className=" italic">Flexible Car Salesperson Training (Online)</h2>
        ...
        <div className=" grid grid-auto-flow grid-cols-3" id="programDetail">
          <div className="justify-items-center ">
            ...
            <div className="PAScroll flex-nowrap justify-content-center">
              <div id="PAB1 " className="PA ">
                Learn From Paul Iacobazzi
              </div>
              <div id="PAB2 " className="PA ">
                Build Connections with Talents and Employers
              </div>
              <div id="PAB3 " className="PA">
                Obtain follow-up support from Paul
              </div>
            </div>
          </div>
          <Carousel images={images} />
          <div className=" border-black m-10  justify-content-center place-items-center">
            <iframe
              id="ytIntro"
          ...
          <div className=" mx-10">
            <div className="bold py-10">
              The Auto Trainer(Online) Will Teach You
            </div>
            <div className="wrap justify-content-center justify-items-center flex-column place-items-center">
            ...
            <div className="italic font-bold my-4">
              It&apos;s about finding you the right FIT – and it&apos;s what we
              do best.
            </div>

            <div className="Ptip ">
              <h3 className="text-center">Paul’s tips of the day</h3>
              <div className="flex-column place-items-center">
                <div className="PtipEach">
                  The first 10 words you say are more important than your next
                  1,000. Please don't ask a customer if they have been helped
                  when you have seen then stand in your showroom for 5 minutes
                  by themselves.
                </div>{" "}
                <div className="PtipEach">
                  ...
                  Treat them always like you wanted to be treated and the
                  results will often be a positive one.
                </div>{" "}
                <div className="PtipEach">
                  The Auto Trainer sales seminar is all about training and
                  motivating people that are at a crossroads in their career. No
                  experience or some experience doesn't really matter. We want
                  people to embrace the concepts of building a successful
                  platform through our mentoring and coaching program. More
                  often than not its a confidence issue and fear of the unknown
                  when changing careers. At The Auto Trainer we firmly believe
                  that if you can Conceive, and that you can Believe, then you
                  can Achieve. Believe in yourself and we can elevate you the
                  rest of the way. Its never too late to start a new career.
                </div>
              </div>
            </div>
          </div>
