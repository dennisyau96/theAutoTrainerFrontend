    ...
    <>
      <div className="text-center justify-items-center" id="programDiv">
        ...
        <p className="text-justify w-50">
          ...
          you placed for not just a job but a career in the car business. We
          have now placed over 1000 candidates with 250 top performers
        ...
        <p>
          ...
          <ul className="border-1 border-black justify-items-center">
            ...
            <li className="teachItem block">
              Learn the art of persuasive selling techniques without being
              “pushy”
            </li>
            <li className="teachItem block">
              Ask intelligent questions to gather the right information Use
              active listening skills to understand the customers needs
            </li>
            <li className="teachItem block">
